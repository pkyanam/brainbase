    ...
    <div className="min-h-screen bg-bb-bg-primary text-bb-text-primary">
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6 text-sm text-bb-text-secondary leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-bb-text-primary mt-8">Usage</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-bb-text-primary mt-8">Data Ownership</h2>
          <p>
            You retain full ownership of the data you store in your brain. We do not train AI models on your data
            without explicit consent.
          </p>
          <h2 className="text-lg font-semibold text-bb-text-primary mt-8">Limitation of Liability</h2>
          <p>
