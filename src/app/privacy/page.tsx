  ...
  return (
    <div className="min-h-screen bg-bb-bg-primary text-bb-text-primary">
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6 text-sm text-bb-text-secondary leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-bb-text-primary mt-8">Data Deletion</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-bb-text-primary mt-8">Contact</h2>
          <p>
            Questions? Email us at <a href="mailto:hello@brainbase.belweave.ai" className="text-bb-accent hover:underline">hello@brainbase.belweave.ai</a>.
          </p>
        </div>
      </div>
      <Footer />
